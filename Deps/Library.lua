...
do
	...
	do
		function Library:NewPicker(name, default, parent, count, flag, callback)
			...
			Library:Connection(game:GetService("UserInputService").InputBegan, function(Input)
				if Colorpicker.Visible and (Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch) then
	...
	do
		...
		function Sections:Toggle(Properties)
			...
			function Toggle:OptionList(Properties)
				...
				Library:Connection(game:GetService("UserInputService").InputBegan, function(Input)
					...
					if OptionList.Visible and (Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch) then
		...
		function Sections:List(Properties)
			...
			--
			Library:Connection(game:GetService("UserInputService").InputBegan, function(Input)
				if ToggleContent.Visible and (Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch) then
