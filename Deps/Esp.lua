...
utility.funcs.update = 
    ...
    function(player)
                    ...
                    elseif Config.Bars.Type == "Rainbow" then
                        if Config.Bars.Moving.Enabled then
                            playerCache.Bars.Health.Gradient.Color = ColorSequence.new({
                                ...
                                ColorSequenceKeypoint.new(0.16,  Color3.fromHSV((t + 0.16) % 1, 1, 1)),
                                ...
                                ColorSequenceKeypoint.new(0.83,  Color3.fromHSV((t + 0.83) % 1, 1, 1)),
        ...
        if Config.Text.Weapon.Enabled then
            ...
            distanceYOffset = distanceYOffset + 15
        else
