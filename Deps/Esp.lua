...
utility.funcs.update = 
    ...
    function(player)
        ...
        local weaponYOffset = baseY + scale.Y + bottomTextOffset
        
        if Config.Text.Distance.Enabled then
            distanceLabel.Visible = true
            distanceLabel.Position = UDim2.new(0, baseX - (distanceLabel.AbsoluteSize.X / 2), 0, weaponYOffset)
            ...
            weaponYOffset = weaponYOffset + 12
        else
        ...
        if Config.Text.Weapon.Enabled then
            ...
            weaponLabel.Position = UDim2.new(0, baseX - (weaponLabel.AbsoluteSize.X / 2), 0, weaponYOffset)
